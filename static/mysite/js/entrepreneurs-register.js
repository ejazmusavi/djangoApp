...
else
{
 ...
 if(working_years =="")
  {
    $("#working_years_error").text('Enter the study of year.');
        document.getElementById("working_years_error").style.color = "red";

    return false;
  }

  working_years = parseInt(working_years);

if (working_years > 45)
{
 $("#working_years_error").text('Max value of working year is 45.');
        document.getElementById("working_years_error").style.color = "red";

    return false;
}
if(working_years >=0 && working_years <=45)
{
  $("#working_years_error").text('');
  console.log('wirking year done.')
}
...
if(no_of_employees =="")
  {
    $("#no_of_employees_error").text('Enter the study of year.');
        document.getElementById("no_of_employees_error").style.color = "red";

    return false;
  }

  no_of_employees = parseInt(no_of_employees);

if (no_of_employees > 1000000)
{
 $("#no_of_employees_error").text('Max value of working year is 1000000.');
        document.getElementById("no_of_employees_error").style.color = "red";

    return false;
}
if(no_of_employees >=0 && no_of_employees <=1000000)
{
  $("#no_of_employees_error").text('');
  console.log('working year done.')
}
...
if(programme_title.length == 0)
 {
  $("#programme_title_error").text('Enter the Programme Title.');
      document.getElementById("programme_title_error").style.color = "red";
      return false;
 }

 if(programme_title.length > 20)
  {

    $("#programme_title_error").text('Max length of Programme Title is 15.');
        document.getElementById("programme_title_error").style.color = "red";

    return false;

  }
  if(programme_title.length > 0 && programme_title.length <= 20)
  {
    $("#programme_title_error").text('')
    console.log('phone_number done.')
  }
